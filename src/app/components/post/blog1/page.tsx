...
const Blog1 = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      Here is a recap of some of our biggest AI updates from December including the release of Gemini 2.0 Google DeepMind s state-of-the-art weather prediction model GenCast, and Willow — our quantum chip that delivers a major breakthrough in quantum computing.
      </p>
      <br/>
      <p >a text card reading The big picture
The agentic era of AI is here. Over the past year, we have been investing in developing more agentic models — which can understand more about the environment around you and take action on your behalf with your supervision. This month we released Gemini 2.0, our most capable model yet, with agentic capabilities for developers, enterprises and people everywhere. We also introduced a range of experimental models for developers to explore, including gemini-exp-1206 in AI Studio and Gemini Advanced, and an experimental “thinking” version of Gemini 2.0.

These advancements bring us closer to our vision for a universal AI assistant, to make information even more accessible for everyone. Because information is at the core of human progress  and we will continue to push the frontiers of AI to organize that information, and make it truly useful for all.
